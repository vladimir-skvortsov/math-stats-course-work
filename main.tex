...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.45Vhist.png}
        \caption{Гистограмма распределения значений выходного напряжения}
    \end{center}
\end{figure}
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.45Vbox.png}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.35Vhist.png}
        \caption{Гистограмма распределения значений выходного напряжения}
    \end{center}
\end{figure}
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.35Vbox.png}
        \caption{Боксплот распределения значений выходного напряжения}
    \end{center}
\end{figure}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.25Vhist.png}
        \caption{Гистограмма распределения значений выходного напряжения}
    \end{center}
\end{figure}
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.25Vbox.png}
        \caption{Боксплот распределения значений выходного напряжения}
    \end{center}
\end{figure}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.15Vhist.png}
        \caption{Гистограмма распределения значений выходного напряжения}
    \end{center}
\end{figure}
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.15Vbox.png}
        \caption{Боксплот распределения значений выходного напряжения}
    \end{center}
\end{figure}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.05Vhist.png}
        \caption{Гистограмма распределения значений выходного напряжения}
    \end{center}
\end{figure}
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{-0.05Vbox.png}
        \caption{Боксплот распределения значений выходного напряжения}
    \end{center}
\end{figure}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{0.0Vhist.png}
        \caption{Гистограмма распределения значений выходного напряжения}
    \end{center}
\end{figure}
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width = 1\linewidth]{0.0Vbox.png}
        \caption{Боксплот распределения значений выходного напряжения}
    \end{center}
\end{figure}
